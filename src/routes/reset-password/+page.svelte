...
<div class="min-h-screen bg-white fixed inset-x-0 top-0 bottom-0 flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl shadow-lg mb-4">
                ...
                <h1 class="text-3xl font-bold mb-2">
                  <span class="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">รีเซ็ตรหัสผ่าน</span>
                </h1>
        ...
        <div class="bg-white rounded-3xl shadow-xl p-8 backdrop-blur-sm bg-opacity-90">
            <form action="?/reset_password" method="POST" use:enhance={handleSubmit} class="space-y-5">
