    ...
    const handleSave: SubmitFunction = () => {
        ...
        return async ({ update, result }) => {
            ...
            if (result.type === 'success') {
                toastStack.add('แก้ไขข้อมูลสำเร็จ!');
            }

            if (result.type === 'failure') {
                toastStack.add('เกิดข้อผิดพลาด กรุณาลองใหม่', 'error');
            }
        };
    };
</script>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-800 mb-2">
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">โปรไฟล์</span>
            </h1>
        ...
        <div class="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
            <form action="?/update_profile" method="POST" use:enhance={handleSave} class="space-y-5">
                <!-- First Name Input -->
                <div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            type="email"
                            class="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl text-gray-800 bg-gray-50 cursor-not-allowed focus:outline-none"
                            name="email"
                            id="email"
                            readonly
                            disabled={isLoading}
